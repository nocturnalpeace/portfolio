...
const About = () => {
  return (
    <div id='about' className='w-full px-[12%] py-10 scroll-mt-20'>
        <h4 className='text-center mb-2 text-lg font-Ovo' >Introductie</h4>
        <h2 className='text-center text-5xl font-Ovo' >Over mij</h2>
        ...
        <div className='flex w-full flex-col lg:flex-row items-center gap-20 my-20'>
            <div className='w-64 sm:w-80 rounded-3xl max-w-none'>
                ...
                <div className='flex-1'>
                    ...
                    <h4 className='my-6 text-gray-700 font-Ovo' >Programma's die ik gebruik</h4>
