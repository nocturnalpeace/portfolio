...
const Work = ({isDarkMode}) => {
  return (
    <div id='projects' className='w-full px-[12%] py-10 scroll-mt-20'>
       <h4 className='text-center mb-2 text-lg font-Ovo' >Mijn portfolio</h4>
        <h2 className='text-center text-5xl font-Ovo' >Laatste projecten</h2>
      
      <p className='text-center max-w-2xl mx-auto mt-5 mb-12 font-Ovo' >Welkom bij mijn portfolio, hier is een selectie van mijn laatste projecten</p>
