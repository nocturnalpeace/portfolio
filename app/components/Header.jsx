  ...
  return (
    ...
    items-center justify-center gap-4'>
      ...
      className='flex items-end gap-2 text-xl md:text-2xl mb-3 font-Ovo' >
        ...
        Tweedejaars Commmunicatie Multimedia Design student in Amsterdam</motion.h1>
        <motion.p
        initial={{opacity: 0}}
        ...
        <div className='flex flex-col sm:flex-row items-center gap-4 mt-4'>
            ...
            href="/mohamed-ziani-resume.pdf" download className='px-10 py-3 border rounded-full border-gray-500 flex 
