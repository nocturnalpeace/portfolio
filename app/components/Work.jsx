...
const Work = ({isDarkMode}) => {
  return (
    ...
    id='projects' className='w-full px-[12%] py-10 scroll-mt-20'>
       ...
       className='text-center mb-2 text-lg font-Ovo' >Mijn portfolio</motion.h4>
        <motion.h2
        initial={{ y: -20, opacity: 0 }}
        whileInView={{ y: 0, opacity: 1 }}
        transition={{ delay: 0.5, duration: 0.5 }}
        className='text-center text-5xl font-Ovo' >Laatste projecten</motion.h2>
      
      <motion.p
      initial={{ opacity: 0 }}
      whileInView={{ opacity: 1 }}
      transition={{ delay: 0.7, duration: 0.5 }}
      className='text-center max-w-2xl mx-auto mt-5 mb-12 font-Ovo' >Welkom bij mijn portfolio, hier is een selectie van mijn laatste projecten</motion.p>
...
text-gray-70 border-[0.5px] border-gray-700 rounded-full py-3 px-10 mx-auto my-20 hover:bg-lightHover 
duration-500 dark:text-white dark:border-white dark:hover:bg-darkHover'>
    Laat meer zien <Image src={isDarkMode ? assets.right_arrow_bold_dark : assets.right_arrow_bold} alt='pijltje rechts' className='w-4' />
</motion.a>
    </motion.div>
  )
}
